...
The Apache License 2.0 ([Section 6](https://www.apache.org/licenses/LICENSE-2.0#trademarks)) explicitly states that it does not grant permission to use the trade names, trademarks, service marks, or product names of the Licensor. This trademark policy supplements that provision.

## Enforcement

LivelyGig LLC reserves the right to take action against any use of its trademarks that it considers unauthorized or likely to cause confusion. Unauthorized use may result in legal action.
