...
namespace Extension.Services.SignifyService.Models {
    ...
    public record EventMessage(
        ...
        [property: JsonPropertyName("kt")] [property: JsonConverter(typeof(ThresholdValueConverter))] ThresholdValue Kt = null!,
        [property: JsonPropertyName("k")] List<string> K = null!,
        [property: JsonPropertyName("nt")] [property: JsonConverter(typeof(NullableThresholdValueConverter))] ThresholdValue? Nt = null,
