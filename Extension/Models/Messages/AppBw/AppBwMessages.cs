...
namespace Extension.Models.Messages.AppBw {
    ...
    public readonly struct AppBwMessageType : IEquatable<AppBwMessageType> {
        ...
        public static class Values {
            ...
            public const string RequestBurstPoll = "AppBw.RequestBurstPoll";
        ...
        public static AppBwMessageType RequestBurstPoll { get; } = new(Values.RequestBurstPoll);
        ...
        public static bool TryParse(string? value, out AppBwMessageType result) {
            ...
            switch (value) {
                ...
                case Values.RequestAcknowledgeMigrationNotice:
                    ...
                    return true;
                case Values.RequestBurstPoll:
                    result = RequestBurstPoll;
                    return true;
