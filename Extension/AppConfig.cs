...
namespace Extension {
    public static class AppConfig {
        ...
        public static readonly List<KeriaPreset> PresetAgents = [
            ...
            new KeriaPreset("Veridian Dev Testnet (frequently reset)", "https://keria.dev.idw-sandboxes.cf-deployments.org", "https://keria-boot.dev.idw-sandboxes.cf-deployments.org"),
